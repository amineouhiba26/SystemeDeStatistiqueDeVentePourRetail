...
import com.satoripop.ssvr.repository.PaymentRepository;
import com.satoripop.ssvr.service.PaymentService;
...
/**
 * REST controller for managing {@link com.satoripop.ssvr.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
