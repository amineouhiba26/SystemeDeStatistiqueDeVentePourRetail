...
export class PaymentUpdateComponent implements OnInit {
  ...
  protected updateForm(payment: IPayment): void {
    ...
    this.ordersSharedCollection = this.orderService.addOrderToCollectionIfMissing<IOrder>(this.ordersSharedCollection, payment.payment);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.orderService
      ...
      .pipe(map((orders: IOrder[]) => this.orderService.addOrderToCollectionIfMissing<IOrder>(orders, this.payment?.payment)))
