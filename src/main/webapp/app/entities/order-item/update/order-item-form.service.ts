...
type OrderItemFormGroupContent = {
  ...
  quantityOrdered: FormControl<IOrderItem['quantityOrdered']>;
  quantityCancelled: FormControl<IOrderItem['quantityCancelled']>;
  quantityInvoiced: FormControl<IOrderItem['quantityInvoiced']>;
...
export class OrderItemFormService {
  createOrderItemFormGroup(orderItem: OrderItemFormGroupInput = { id: null }): OrderItemFormGroup {
    ...
    return new FormGroup<OrderItemFormGroupContent>({
      ...
      quantityOrdered: new FormControl(orderItemRawValue.quantityOrdered, {
        validators: [Validators.required],
      }),
      quantityCancelled: new FormControl(orderItemRawValue.quantityCancelled),
      quantityInvoiced: new FormControl(orderItemRawValue.quantityInvoiced),
