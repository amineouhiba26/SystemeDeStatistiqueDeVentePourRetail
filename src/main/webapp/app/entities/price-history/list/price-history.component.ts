...
export class PriceHistoryComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPriceHistory): string => this.priceHistoryService.getPriceHistoryIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.priceHistories = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPriceHistory[] | null): IPriceHistory[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.priceHistoryService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
